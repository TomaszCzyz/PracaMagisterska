...
\begin{center}    
    ...
    \includegraphics[scale=1.3]{logoAGH.pdf}
    
    \vspace*{2mm}
    {\scalebox{0.9}
        {\sffamily{\large{\bfseries{\scshape Akademia Górniczo-Hutnicza im. Stanisława Staszica w Krakowie}}}}
        \vspace*{1mm}
        {\sffamily\small\bfseries Wydział Matematyki Stosowanej}
    }
    \vspace*{15mm}

    {\sffamily\Large Praca dyplomowa}
    \vspace*{9mm}
    
    {\sffamily\Large\itshape Aproksymacja funkcji kawałkami regularnych przy użyciu informacji dokładnej i niedokładnej}
    \vspace*{3mm}

    {\sffamily\Large\itshape Approximation of piecewise smooth functions using exact and inexact information}
    \vspace{\fill}
\end{center}
...
\noindent
{
    ...
    \begin{tabular}{p{45mm}l}
        Autor: & {\itshape Tomasz Czyż}\\[-1mm]
        Kierunek studiów: & {\itshape Matematyka}\\[-1mm]
        Opiekun pracy: & {\itshape dr Maciej Goćwin}\\
    \end{tabular}
}

\vspace*{17mm}

\centerline{\small\sffamily Kraków, 2021}
